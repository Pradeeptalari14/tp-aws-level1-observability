# ☁️ Four-i Level-1 Observability (AWS)
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/aws-level1-observability/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-aws-level1-observability.git
cd tp-aws-level1-observability
```
...
```bash
kubectl port-forward deployment/tp-aws-level1-observability 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── cloudwatch_dashboard.json     # Main configuration file
```
...
---
*Generated by [Four-i Level-1 Observability (AWS) Studio](https://pradeeptalari14.github.io/portfolio/tools/aws-level1-observability/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
