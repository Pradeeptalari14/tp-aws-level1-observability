# 🔧 Troubleshooting Guide — Four-i Level-1 Observability (AWS)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-aws-level1-observability/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/aws-level1-observability/)
